\addlyrics {
 \set stanza = #"1. "
 Give ear to what is right, O Lord!
 O list -- en to my cry!
 Give heed to this my earn -- est prayer
 From lips which do not lie.

 \set stanza = #"2. "
 May judge -- ment from Your pres -- ence come
...
\addlyrics {
 ...
 \set stanza = #"6. "
 In wond -- rous ways You mer -- cy show,
...
\addlyrics {
 \set stanza = #"13. "
 But as for me, with right -- eus -- ness
